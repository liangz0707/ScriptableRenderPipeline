...
| **Diffusion Profile List**      | The [Diffusion Profile List](Diffusion-Profile.html) Asset stores Subsurface Scattering and Transmission Control profiles for your Project. To create a Diffusion Profile Settings Asset, go to **Assets > Create > Rendering** and click **Diffusion Profile**. |
